...
.ui-progress{background-color:#F0F0F0;border-radius:var(--radius);box-sizing:border-box}.ui-progress div{background-size:56px 56px;animation:progress 20s infinite linear forwards;margin-right:30px;background-image:repeating-linear-gradient(45deg,#119CBC,#119CBC 10px,#4993E7 10px,#4993E7 20px);text-align:right;font-size:10px;color:#FFF;padding:2px 5px 0 0;height:18px;font-weight:bold;border-radius:3px;min-width:30px}.ui-dark .ui-progress{background-color:#303030}@keyframes progress{from{background-position:0% 0%}to{background-position:100% 0%}}
